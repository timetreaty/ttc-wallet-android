...
public class JingCaiThreeAdapter extends BaseAdapter {

    private Context context;
    private List<JingCaiJiLuBean.DataBean.BetInfoVos3Bean> list;

    public JingCaiThreeAdapter(Context context, List<JingCaiJiLuBean.DataBean.BetInfoVos3Bean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.jingcai_two_img.setImageResource(R.drawable.jingcai_cuo);
        return convertView;
    }
